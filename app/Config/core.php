 ...
 */
	Configure::write('Security.salt', 'something long and containing lots of different values');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', 'something long and containing lots of different values');
